...
<style>
    ...
    .form-control:focus, .form-select:focus {
        border-color: #1a5f3a;
        box-shadow: 0 0 0 0.2rem rgba(26, 95, 58, 0.1);
    }
        ...
        <form action="{{ route('admin.fasilitas.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                    ...
                    <option value="utama" {{ old('kategori') == 'utama' ? 'selected' : '' }}>Fasilitas Utama</option>
                    <option value="pendukung" {{ old('kategori') == 'pendukung' ? 'selected' : '' }}>Fasilitas Pendukung</option>
                </select>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" rows="4" class="form-control @error('deskripsi') is-invalid @enderror" 
                          placeholder="Jelaskan fasilitas ini secara detail..." required>{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="icon" id="iconInput" class="form-control @error('icon') is-invalid @enderror" 
                       value="{{ old('icon') }}" placeholder="Contoh: fas fa-laptop" required>
            ...
            <!-- Fitur (Hanya untuk Fasilitas Utama) -->
            <div class="form-group">
                    ...
                    <div id="fiturWrapper">
                        <div class="fitur-item">
                            <input type="text" name="fitur[]" class="form-control fitur-input" 
                                   placeholder="Contoh: AC & Ventilasi Baik" value="{{ old('fitur.0') }}">
...
// Load old fitur values if validation fails
@if(old('fitur'))
