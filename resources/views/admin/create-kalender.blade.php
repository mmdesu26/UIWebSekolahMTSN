...
@section('title', 'Tambah Kalender Pendidikan')
@section('page-title', 'Tambah Kalender Pendidikan')
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="semester" class="form-select @error('semester') is-invalid @enderror" required>
                            ...
                            <option value="ganjil" {{ old('semester') == 'ganjil' ? 'selected' : '' }}>Semester Ganjil (Juli - Desember)</option>
                            <option value="genap" {{ old('semester') == 'genap' ? 'selected' : '' }}>Semester Genap (Januari - Juni)</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                            ...
                            <option value="libur" {{ old('kategori') == 'libur' ? 'selected' : '' }}>🏝️ Libur Nasional</option>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul') }}" placeholder="Contoh: Masa Pengenalan Lingkungan Sekolah (MPLS)" required>
                        @error('judul') <small class="text-danger">{{ $message }}</small> @enderror
                    </div>

                    <div class="col-12">
                        <label class="form-label">Keterangan <span class="text-danger">*</span></label>
                        <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="6" placeholder="Deskripsi lengkap tentang kegiatan..." required>{{ old('keterangan') }}</textarea>
